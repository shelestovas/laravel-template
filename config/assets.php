	...
	'default' => [
		...
		'collections' => array(
		    ...
		    'admin_assets' => array(
                ...
                'admin/assets/css/icons/icomoon/styles.css',
                'admin/assets/css/bootstrap.css',
                'admin/assets/css/core.css',
                'admin/assets/css/components.css',
                'admin/assets/css/colors.css',
                'admin/assets/css/custom.css',

                'admin/assets/js/plugins/loaders/pace.min.js',
                'admin/assets/js/core/libraries/jquery.min.js',
                'admin/assets/js/core/libraries/bootstrap.min.js',
                'admin/assets/js/plugins/loaders/blockui.min.js',
                'admin/assets/js/plugins/forms/selects/select2.min.js',
                'admin/assets/js/plugins/forms/styling/uniform.min.js',
                'admin/assets/js/plugins/notifications/pnotify.min.js',
                'admin/assets/js/core/app.js',
            ),

            'admin_datatables' => array(
                'admin/assets/js/plugins/tables/datatables/datatables.min.js',
                'admin/assets/js/plugins/tables/datatables/extensions/buttons.min.js',
